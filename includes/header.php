		...
		<div class="header-wrap">
			...
			<div class="header-right">
				<ul>
					...
					<li>
						<a href="javascript:void(0)" class="login-hide mx-4" data-bs-toggle="modal" data-bs-target="#login-signup">Signup / Login</a>
					</li>
					<!-- <li>
						<a href="javascript:void(0)" class="cart-icon" id="cart-side-toggle">
